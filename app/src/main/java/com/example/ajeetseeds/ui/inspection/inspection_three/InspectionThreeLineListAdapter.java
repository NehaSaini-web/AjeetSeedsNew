...
public class InspectionThreeLineListAdapter extends BaseAdapter {
    private List<InspectionOneModel.InspectionThreeLineModel> listdata;
    private Activity activity;

    public InspectionThreeLineListAdapter(Activity activity, List<InspectionOneModel.InspectionThreeLineModel> listdata) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.inspection_three_add_line_listview, null);
