...
public class InspectionLineListAdapter extends BaseAdapter {
    ...
    public String getInspection(InspectionModel.Inspection_Line inspection_line) {
        if ((inspection_line.crop_code.equalsIgnoreCase("FCROP")||inspection_line.crop_code.equalsIgnoreCase("VEG")) && inspection_line.item_croptype.equalsIgnoreCase("Improved")) {
