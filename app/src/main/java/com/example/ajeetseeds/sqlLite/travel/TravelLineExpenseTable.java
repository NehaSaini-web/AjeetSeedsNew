...
public class TravelLineExpenseTable {
    ...
    public void insert(TravelLineExpenseModel data,String lineSend) {
   ...
   public List<TravelLineExpenseModel> fetchLocalUnsendLine() {
        ...
        String[] columns = new String[]{this.android_travelcode,this.travelcode,this.line_no,this.date,this.from_loc,this.to_loc,this.departure,this.arrival,this.fare,this.mode_of_travel,this.loading_in_any,this.distance_km,this.fuel_vehicle_expance,this.daily_express,this.vehicle_repairing,this.local_convance,this.other_expenses,this.total_amount_calulated,this.created_on,this.lineSend};
    ...
    public List<TravelLineExpenseModel> fetch(String travelcode) {
        List<TravelLineExpenseModel> returnData = new ArrayList<>();
        String[] columns = new String[]{this.android_travelcode,this.travelcode,this.line_no,this.date,this.from_loc,this.to_loc,this.departure,this.arrival,this.fare,this.mode_of_travel,this.loading_in_any,this.distance_km,this.fuel_vehicle_expance,this.daily_express,this.vehicle_repairing,this.local_convance,this.other_expenses,this.total_amount_calulated,this.created_on};
