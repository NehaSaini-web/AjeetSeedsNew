...
public class TravelLineExpenseModel {
    ...
    public TravelLineExpenseModel(String android_travelcode,String travelcode, String line_no, String date, String from_loc, String to_loc, String departure, String arrival, String fare, String mode_of_travel, String loading_in_any, String distance_km, String fuel_vehicle_expance, String daily_express, String vehicle_repairing, String local_convance, String other_expenses, String total_amount_calulated, String created_on) {
